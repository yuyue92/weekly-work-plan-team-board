      ...
      <div class="modal member-modal">
        <div class="modal-header">
          ...
          <div class="modal-hour-summary">
            <span v-for="(key, idx) in hourKeys" :key="key" class="tag hour-tag" :class="hourTagClass(weeklyHours[key])"
        ...
        <div class="modal-body member-modal-body">
          ...
          >
            <div class="member-section-header">
              ...
              <button class="btn btn-outline-primary btn-sm" type="button" @click="$emit('add-item', status)">
                ＋ Work Item
              </button>
            </div>

            <div v-if="!draft[status].length" class="empty-note">Drag a Work Item here, or click "＋ Work Item".</div>
                ...
                <div class="member-item-fields">
                  ...
                  <div class="form-group">
                    ...
                    <input
                      class="form-control"
                      type="date"
                      v-model="item.expect_complete_date"
                      @change="$emit('dirty')"
                    />
                  </div>
                  <div class="form-group">
              ...
              <div class="member-item-tasks">
                <div class="member-tasks-header">
                  ...
                  <button
                    ...
                    type="button"
                    @click="$emit('add-task', status, itemIndex)"
                  >
                    ＋ Add Task
                  </button>
                </div>
...
const emit = defineEmits(["close", "save", "dirty", "add-item", "delete-item", "add-task", "delete-task", "move-item"]);
